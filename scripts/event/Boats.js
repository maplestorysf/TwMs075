...
function scheduleNew() {
    ...
    Ellinia_docked.broadcastMessage(CField.setBoatState(1));
    Orbis_Station.broadcastMessage(CField.setBoatState(1));
...
function takeoff() {
    ...
    Ellinia_docked.broadcastMessage(CField.setBoatState(2));
    Orbis_Station.broadcastMessage(CField.setBoatState(2));
...
function invasion() {
    ...
    if (numspawn == 2) {
        ...
        Boat_to_Orbis.broadcastMessage(CField.boatEffect(10, 4));
        Boat_to_Ellinia.broadcastMessage(CField.boatEffect(10, 4));
