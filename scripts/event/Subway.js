...
function scheduleNew() {
    ...
    KC_docked.broadcastMessage(CWvsContext.serverNotice(6, "地鐵列車到站了。"));
    NLC_docked.broadcastMessage(CWvsContext.serverNotice(6, "地鐵列車到站了。"));
...
function takeoff() {
    ...
    KC_docked.broadcastMessage(CWvsContext.serverNotice(6, "地鐵列車已經離開了."));
    NLC_docked.broadcastMessage(CWvsContext.serverNotice(6, "地鐵列車已經離開了."));
    var temp = rideTime / 1000;
    Subway_to_KC.broadcastMessage(CField.getClock(temp));
    Subway_to_NLC.broadcastMessage(CField.getClock(temp));
