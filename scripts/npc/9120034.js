...
function action(mode, type, selection) {
    ...
    case 10:
        if (selection == 0) {
            if (cm.haveItem(4032168, 1) && cm.haveItem(4032181, 3500) && cm.haveItem(4032171, 1) && cm.haveItem(2070006, 1) && (cm.getMeso() >= 1000000000)) {
                cm.gainItem(4032171, -1);
                ...
                cm.sendNext("咦？你好像沒有必要的素材嘛？\r\n製造#t2070019#需要有#t4032168#、#t4032170#、#t02070006#1個、#t4032181#3,500片以及1,000,000,000金幣。");
            }
        } else {
            if (cm.haveItem(4032168, 1) && cm.haveItem(4032181, 2500) && cm.haveItem(4032170, 1) && cm.haveItem(2330003, 1) && (cm.getMeso() >= 150000000)) {
                ...
                cm.sendNext("咦？你好像沒有必要的素材嘛？\r\n製造#t2330007#需要有#t4032168#、#t4032171#、#t02330003#1個、#t4032181#2,500片以及150,000,000金幣。");
            }
        }
        cm.dispose();
        break;
