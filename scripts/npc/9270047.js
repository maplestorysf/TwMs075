...
function start() {
    ...
    if (!cm.getPlayer().isGM() && cm.getPlayer().getClient().getChannel() != 7 && cm.getPlayer().getClient().getChannel() != 8 && cm.getPlayer().getClient().getChannel() != 9) {
        cm.sendOk("熊獅只能在7、8、9頻挑戰.");
        cm.dispose();
        return;
    }
