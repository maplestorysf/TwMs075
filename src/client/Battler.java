...
public class Battler implements Serializable {
    ...
    private EnumMap<PokemonStat, Pair<Byte, Double>> mods = new EnumMap<>(PokemonStat.class);
    //temp stats
    private long hp;
    ...
    private List<Integer> damagedChars = new ArrayList<>(); //distribute exp according
    ...
    private final void calculateFamily() {
        ...
        resetStats();
        final List<PokemonMob> ourFamilies = new ArrayList<>();
