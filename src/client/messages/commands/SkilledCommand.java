...
public class SkilledCommand {
    ...
    public static class FakeReport extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            ...
            FileoutputUtil.logToFile("紀錄/指令/玩家回報黑單.txt", "\r\n  " + FileoutputUtil.CurrentReadable_TimeGMT() + " GM " + c.getPlayer().getName() + " 在回報系統黑單了 " + input);
            return true;
        }
    ...
    public static class Heal extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            ...
            c.getPlayer().getStat().setMp(c.getPlayer().getStat().getCurrentMaxMp(c.getPlayer().getJob()));
