...
public class BattleConstants {
                ...
                if (!pokedex.containsKey(Integer.valueOf(id))) {
                    ...
                    if (mtm != null) {
                        ...
                        for (Pair<Integer, Integer> mt : mtm) {
                            pe.maps.add(new Pair<>(mt.left, (int) Math.round((1.0 / (double) mapsToMobs.get(getMap(mt.left)).size()) / (double) mt.right * 10000.0)));
                        }
                    } else {
                        pe.maps = null;
                    }
    ...
    public static class PokedexEntry {
        ...
        public Map<Integer, Integer> pre = new LinkedHashMap<>(), evo = new LinkedHashMap<>();
    ...
    public enum PokemonElement { //where the element is the attacking type
        ...
        public Set<Integer> immune = new HashSet<>(), notEffective = new HashSet<>(), superEffective = new HashSet<>();
