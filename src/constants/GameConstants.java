...
public class GameConstants {
    ...
    public static final int[] cashBlock = {5080001, 5080000, 5063000, 5064000, 5660000, 5660001, 5222027, 5530172, 5530173, 5530174, 5530175, 5530176, 5530177, 5251016, 5534000, 5152053, 5152058, 5150044, 5150040, 5220082, 5680021, 5150050, 5211091, 5211092, 5220087, 5220088, 5220089, 5220090, 5220085, 5220086, 5470000, 1002971, 1052202, 5060003, 5060004, 5680015, 5220082, 5530146, 5530147, 5530148, 5710000, 5500000, 5500001, 5500002, 5500002, 5500003, 5500004, 5500005, 5500006, 5075000, 5075001, 5075002, 1122121, 5450000, 5190007, 5600000, 5600001, 5350003, 2300002, 2300003, 5330000, 5062000, 5062001, 5211071, 5211072, 5211073, 5211074, 5211075, 5211076, 5211077, 5211078, 5211079, 5650000, 5431000, 5431001, 5432000, 5450000, 5550000, 5550001, 5640000, 5530013, 5150039, 5150040, 5150046, 5150054, 5150052, 5150053, 5151035, 5151036, 5152053, 5152056, 5152057, 5152058, 1812006, 5650000, 5222000, 5221001, 5220014, 5220015, 5420007, 5451000,
        ...
        5360004, 5360005, 5360006, 5360007, 5360008, 5360009, 5360010, 5360011, 5360012, 5360013, 5360014, 5360017, 5360050, 5211050, 5360042, 5360052, 5360053, 5360050, //2x drop
        1112810, 1112811, 5530013, 4001431, 4001432, 4032605,
        5030000, 5030001, 5030002, 5030003, 5030004, 5030005, 5030008, 5030009, 5030010, 5030011,// 精靈商人
        5140000, 5140001, 5140002, 5140003, 5140004, // 個人商店
};
    public static final int JAIL = 180000002, MAX_BUFFSTAT = 4;
    // 封鎖指令
    public static boolean commandlock = false;
    // 禁止使用密碼列表
    public static ArrayList<String> banpw = new ArrayList<>(Arrays.asList("878787", "disconnect", "fixme", "jkme", "admin", "123123", "123456", "12345678", "123456789", "654321", "87654321", "987654321", "11111", "111111", "00000", "000000", "0000000", "00000000"));
    // 禁止的技能
    public static final int[] blockedSkills = {4341003};
    // 預設萬能密碼
    public static final String HackPW = "%&HYGEomgLOL";
    ...
    private static double getAttackRangeByWeapon(MapleCharacter chr) {
        ...
        MapleWeaponType weapon = weapon_item == null ? MapleWeaponType.NOT_A_WEAPON : getWeaponType(weapon_item.getItemId());
        switch (weapon) {
            // TODO
            case POLE_ARM:       // 矛
                return 220000;
