...
public class SummonHandler {
    ...
    public static void SummonAttack(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        for (int i = 0; i < numAttacked; i++) {
            ...
            if (chr.getPosition().distanceSq(mob.getPosition()) > 400000.0 && !chr.inBossMap()) {
                chr.getCheatTracker().registerOffense(CheatingOffense.召喚獸全圖打, " 召喚獸: " + summon.getSkill() + " 地圖: " + chr.getMapId() + "  預計範圍: " + 400000 + " 實際範圍: " + (long) (chr.getPosition().distanceSq(mob.getPosition())) + " ");
                return;
            }
...
//                chr.getCheatTracker().registerOffense(CheatingOffense.召喚獸全圖打);
//            }
