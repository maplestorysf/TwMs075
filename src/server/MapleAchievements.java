...
public class MapleAchievements {
    ...
    protected MapleAchievements() {
        ...
        achievements.put(2, new MapleAchievement("達到30級", 30, false));
        achievements.put(3, new MapleAchievement("達到70級", 60, false));
        achievements.put(4, new MapleAchievement("達到120級", 100, false));
        achievements.put(5, new MapleAchievement("達到200級", 120, false));
        achievements.put(7, new MapleAchievement("達到50名聲", 30, false));
        ...
        //achievements.put(35, new MapleAchievement("建立公會", 30, false));
