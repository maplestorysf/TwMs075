...
public class MapleTrade {
    ...
    public final void chat(String message) {
        ...
        if (ServerConstants.LOG_CHAT && chr.get().getCanTalk()) {
            FileoutputUtil.logToFile("聊天/交易聊天.txt", " " + FileoutputUtil.CurrentReadable_TimeGMT() + " IP: " + chr.get().getClient().getSessionIPAddress() + " 『" + chr.get().getName() + "』對『" + partner.getChr().getName() + "』的交易聊天：  " + message + "\r\n");
        }
