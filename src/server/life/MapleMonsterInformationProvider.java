...
public class MapleMonsterInformationProvider {
    ...
    public void addExtra() {
        ...
        if (GameConstants.GMS) { //　載入WZ中的掉寶資訊
    ...
    public Map<Integer, String> getAllMonsters() {
        if (mobCache.isEmpty()) {
            final MapleDataProvider stringData = MapleDataProviderFactory.getDataProvider((new File(System.getProperty("net.sf.odinms.wzpath") + "/String.wz")));
