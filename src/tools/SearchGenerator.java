...
public class SearchGenerator {
    ...
    public static Map<Integer, String> getSearchs(SearchType type) {
        ...
        switch (type) {
            case 道具:
                //  for (Entry<Integer, ItemInformation> entry : MapleItemInformationProvider.getInstance().getAllItems()) {
            ...
            case NPC:
                ...
                break;
            case 地圖:
                MapleData data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/String.wz")).getData("Map.img");
